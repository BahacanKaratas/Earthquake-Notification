 ...
 */
public class DoublyLinkedList<String> implements Cloneable{
    ...
    public static class Node<String> {
        ...
        private Node<String> prev;            // reference to the previous node in the list
    ...
    public Node<String> header;                    // header sentinel

    /** Sentinel node at the end of the list */
    private Node<String> trailer;                   // trailer sentinel
     ...
     */
    private void addBetween(String e, Node<String> predecessor, Node<String> successor) {
     ...
     */
    public String remove(Node<String> node) {
    ...
    public java.lang.String toString() {
        ...
        Node<String> walk = header.getNext();
        while (walk != trailer) {
